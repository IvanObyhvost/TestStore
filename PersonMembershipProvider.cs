...
namespace TestStore.Providers
{
    public class PersonMembershipProvider : MembershipProvider
    {
        ...
        public PersonMembershipProvider(IAuthenticationService service)
        {
            _authenticationService = service;
        }
        public override bool ValidateUser(string email, string password)
        {
            return _authenticationService.ValidateUser(email, password);
        }
        ...
        public MembershipUser CreateUser(PersonDTO person)
        {
            ...
            try
            {
                ...
                {
                    _authenticationService.AddPerson(person);
        ...
        public override MembershipUser GetUser(string email, bool userIsOnline)
        {
            try
            {
                var user = _authenticationService.GetPersonByEmail(email);
                if (user != null)
                {
